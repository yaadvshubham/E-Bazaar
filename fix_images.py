...
import re
for title, new_url in replacements.items():
    # Regex to find the product block
    pattern = r'("title":\s*"' + re.escape(title) + r'",[^}]+?"image":\s*")https://images\.unsplash\.com/photo-1523381210434-271e8be1f52b\?w=500&q=80(")'
